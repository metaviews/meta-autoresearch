...
Use this template to document one full research cycle in a way that is auditable, comparable, and reusable.
...
- loop question:
- branch or family:
- run type: first pass | revision pass | comparison pass | maturity pass

## Purpose of this run

What was this loop trying to test, produce, or clarify?
